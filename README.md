...
> **当前功能分支：`work/four-language-production-baseline-20260920`。**
> 本分支从准确生产归档 `e553b7f7fed5ed09af0914e006e6660dce3e477e` 出发，
> 仅更新四语言前端：中文默认，保留 Español、Português、English，并保持机构国家与显示语言独立。
> 生产发布范围为 13 个现有静态文件和 3 个新语言文件；其他组件和实际 Nginx 配置不改。
> [发布清单、预检与回退说明](releases/four-language-20260920/README.md)说明如何单独部署前端。
> GitHub 分支存在不等于线上已切换；实际状态以服务器发布收据为准。
> 下文保留原始归档说明，`PROVENANCE.json` 仍描述更新前的原始文件，不改写其历史校验值。
