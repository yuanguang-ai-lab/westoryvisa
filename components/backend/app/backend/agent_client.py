...
def confirm_computer_use_form_entry(job_id, *, base_url=None):
    """Authorize CDP attachment after the operator enters the formal form."""
    return _json_request(
        f"/v1/jobs/{job_id}/confirm-form-entry",
        {},
        timeout=35,
        base_url=base_url,
    )
