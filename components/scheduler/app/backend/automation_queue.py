    ...
    with connect() as connection:
        connection.execute(
            ...
            INSERT INTO automation_workers (
              id, api_url, view_url, control_url, browser_runtime, status, capacity,
            ...
            ON CONFLICT(id) DO UPDATE SET
              ...
              browser_runtime = excluded.browser_runtime,
              status = CASE
            ...
            (
                ...
                control_url.rstrip("/"), browser_runtime,
                status, max(1, int(capacity)),
        ...
        with connect() as connection:
            ...
            connection.execute(
                ...
                INSERT INTO automation_jobs (
                  ...
                  workflow_type, browser_runtime, state, priority, payload_json, status_json,
                ...
                (
                    ...
                    workflow_type, browser_runtime, int(priority), _json(payload),
...
def claim_next_job(connect, *, worker_id, lease_owner, lease_seconds=45, now=None):
    ...
    with connect() as connection:
        ...
        candidate = connection.execute(
            ...
            LIMIT 1
            """ + lock_suffix,
            (worker["browser_runtime"], stamped),
        ).fetchone()
        if not candidate:
            return None
